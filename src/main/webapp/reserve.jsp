...
<div id="">
  <div class="">
    ...
    <a href="<c:url value='' />" id="" class="button">介護や終活</a><br>
    <a href="<c:url value='' />" id="" class="button">相続</a><br>
    <a href="<c:url value='' />" id="" class="button">車や保険</a><br>
    <a href="<c:url value='' />" id="" class="button">金融</a><br>
